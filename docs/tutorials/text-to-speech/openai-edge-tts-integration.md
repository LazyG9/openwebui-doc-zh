...
`openedai-speech` 是一个更全面的选项，允许完全离线生成语音，并提供多种模式选择。
...
查看 [使用方法](#usage) 部分了解请求示例。

# 如果您觉得 [OpenAI Edge TTS](https://github.com/travisvn/openai-edge-tts) 有用，请在 GitHub 上给它一个 ⭐️ 星标
...
您现在可以在 `http://localhost:5050/v1/audio/speech` 和其他可用端点上与 API 交互。查看 [使用方法](#usage) 部分了解请求示例。
...
此外，还有用于 **Azure AI Speech** 和 **ElevenLabs** 的端点，以便在 Open WebUI 允许这些选项的自定义 API 端点时提供潜在的未来支持。
...
有关 `openai-edge-tts` 的更多信息，您可以访问 [GitHub 仓库](https://github.com/travisvn/openai-edge-tts)
